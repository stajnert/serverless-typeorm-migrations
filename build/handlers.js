...
var getMigrationFolder = function () {
    if (!process.env.SLS_TYPEORM_MIGRATIONS_FOLDER) {
        process.exit(1);
    }
    return process.env.SLS_TYPEORM_MIGRATIONS_FOLDER;
};
var handler = function (handlerName) { return function (event, context, callback) { return __awaiter(void 0, void 0, void 0, function () {
    var migration, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, migration[handlerName]()];
            case 2:
                response = _a.sent();
...
var up = handler("runMigration");
exports.up = up;
var down = handler("undoLastMigration");
exports.down = down;
